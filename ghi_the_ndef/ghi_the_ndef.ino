...
*/
// For a http://www. url:
const char * url = "nguyenduytam.com";
...
void loop(void) {
  ...
  uint8_t keya2[6] = { 0xD3, 0xF7, 0xD3, 0xF7, 0xD3, 0xF7 };
  //uint8_t keya2[6] = { 0x00, 0xFF, 0x06, 0xFA, 0xD5, 0x03 };
  Serial.println("");
  ...
  if (success)
  {
    ...
    success = nfc.mifareclassic_AuthenticateBlock (uid, uidLength, 4, 0, keya2);
//    if (!success)
//    {
